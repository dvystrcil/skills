---
name: "Visualize"
description: "Render rich interactive visuals — SVG diagrams, HTML widgets, Chart.js charts, interactive explainers — directly inline in chat using the visualize tool. Use whenever the user asks to visualize, diagram, chart, draw, map out, or illustrate something, or when a topic has spatial, sequential, or systemic relationships a diagram would clarify better than prose. Also use proactively for data comparisons, metrics, architecture, processes, or mechanisms that benefit from a visual."
tags: ["visualization", "rendering", "diagrams", "charts"]
scope: "complex"
---
...
Render rich interactive visuals directly inline in chat using `visualize`. Supports **live streaming** — the iframe fills in token-by-token as you generate the HTML/SVG.
